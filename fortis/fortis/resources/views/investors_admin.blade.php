        ...
        <div class="container-grid both-doc">
            ...
            <div class="body-container" style="width:50%;margin-left: 3%;">
                ...
                <div class="container" style="margin-left: 5%;font-family: 'Open Sans';color: #676363;font-size:14px;">
                    ...
                    <div id="editable-investors-Content" class="editable-investors" style="font-size: 14px; color: #676363; font-weight: normal; word-spacing: 4px; line-height: 19px;" contenteditable="true">
...
<!-- edit and save in home -->
<script>
        // Load saved content from local storage if it exists
        window.onload = function() {
            const savedContent = localStorage.getItem('editable-investors-Content');
            if (savedContent) {
        ...
        function saveContent() {
            const content = document.getElementById('editable-investors-Content').innerHTML;
            localStorage.setItem('editableInvestorsContent', content);
            alert('Content saved!');
        }
    </script>
</html>