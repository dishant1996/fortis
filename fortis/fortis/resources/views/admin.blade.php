...
<body>
    ...
    <div class="body-content">
        <div class="container-grid both-doc">
            ...
            <div class="overview-document" style="font-size: 14px;color: #676363;font-weight: normal;word-spacing: 4px;line-height: 19px" id="overview-document-html">
...
<script>
    ...
    window.onload = function() {
        ...
        if (savedContent) {
            // Injecting saved content into overview-document div
